...
namespace BallisticCalculator.Benchmark;
...
internal class TableLoader
{
    ...
    {
        using Stream stream = typeof(TableLoader).Assembly.GetManifestResourceStream($"BallisticCalculator.Benchmark.resources.{name}.txt")!;
