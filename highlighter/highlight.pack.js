...
;hljs.registerLanguage("java",e)})();/*! `fsharp` grammar compiled for Highlight.js 11.3.1 */
...
end:/"/},f]},c,l,f,o]}}})();hljs.registerLanguage("fsharp",e)})();/*! `dos` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("javascript",e)})();/*! `awk` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("awk",e)})();/*! `gcode` grammar compiled for Highlight.js 11.3.1 */
...
}].concat(n)}}})();hljs.registerLanguage("gcode",e)})();/*! `c` grammar compiled for Highlight.js 11.3.1 */
...
contains:[o]}]}}})();hljs.registerLanguage("vbnet",e)})();/*! `vbscript` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
relevance:0}),e.C_NUMBER_MODE]}}})();hljs.registerLanguage("vbscript",e)})();/*! `php` grammar compiled for Highlight.js 11.3.1 */
...
subLanguage:"xquery"},"self"]}]})})();hljs.registerLanguage("xquery",e)})();/*! `ini` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("ini",e)})();/*! `delphi` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("delphi",e)})();/*! `applescript` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
}]})})();hljs.registerLanguage("bnf",e)})();/*! `kotlin` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
...
})();hljs.registerLanguage("xml",e)})();/*! `pgsql` grammar compiled for Highlight.js 11.3.1 */
(()=>{var E=(()=>{"use strict";return E=>{
...
;hljs.registerLanguage("python-repl",a)})();/*! `ebnf` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("ebnf",e)})();/*! `php-template` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("rust",e)})();/*! `nsis` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";function e(e){
...
;hljs.registerLanguage("nsis",e)})();/*! `vim` grammar compiled for Highlight.js 11.3.1 */
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `basic` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("basic",E)})();/*! `http` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("http",e)})();/*! `diff` grammar compiled for Highlight.js 11.3.1 */
...
},n.FUNCTION_DISPATCH]}}})();hljs.registerLanguage("scss",e)})();/*! `vbscript-html` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>({name:"VBScript in HTML",
subLanguage:"xml",contains:[{begin:"<%",end:"%>",subLanguage:"vbscript"}]})})()
;hljs.registerLanguage("vbscript-html",e)})();/*! `cpp` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("coffeescript",e)})();/*! `typescript` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],t=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],s=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],r=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],c=["arguments","this","super","console","window","document","localStorage","module","global"],i=[].concat(r,t,s)
