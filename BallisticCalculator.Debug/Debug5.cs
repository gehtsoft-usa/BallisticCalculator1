...
namespace BallisticCalculator.Debug
{
    internal static class Debug5
    {
        public static void Do(String[] _)
        {
            ...
            BallisticCalculator.Wind[] wind = { 
                new BallisticCalculator.Wind(new Measurement<VelocityUnit>(20, VelocityUnit.MilesPerHour),
                new Measurement<AngularUnit>(30, AngularUnit.Degree)) 
            };
            ...
            */
            ...
            foreach (var point in trajectory)
            {
                Console.WriteLine($"{point.Distance.In(DistanceUnit.Yard):N0} {point.Drop.In(DistanceUnit.Inch):N1} {point.DropAdjustment.In(AngularUnit.MOA):N1} {point.Windage.In(DistanceUnit.Inch):N1} {point.WindageAdjustment.In(AngularUnit.MOA):N1} {point.Velocity.In(VelocityUnit.FeetPerSecond):N0}");
            }
