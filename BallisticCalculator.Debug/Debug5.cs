    ...
    internal static class Debug5
    {
        public static void Do(String[] _)
        {
            var ammo = new BallisticCalculator.Ammunition(
              ...
              ballisticCoefficient: new BallisticCalculator.BallisticCoefficient(0.112, BallisticCalculator.DragTableId.RA4),
              muzzleVelocity: new Measurement<VelocityUnit>(1090, VelocityUnit.FeetPerSecond),
            ...
            {
                Console.WriteLine($"{point.Time} {point.Distance.In(DistanceUnit.Meter):N0} {point.Velocity.In(VelocityUnit.FeetPerSecond):N0} {point.Drop.In(DistanceUnit.Inch):N3}");
            }
        }
    }
